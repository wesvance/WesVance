...
class HorizontalShareButtons extends React.Component{
  ...
  render(){
    return(
      <div className="horizontalShareContainer"
        style={{
          position:'fixed',
...
export default connect(mapStateToProps, mapDispatchToProps)(HorizontalShareButtons);
